...
tf.app.flags.DEFINE_string('data_dir', '../dataset/svhn', 'Directory to read TFRecords files')
...
tf.app.flags.DEFINE_integer('patience', 10, 'Default 100, set -1 to train infinitely')
